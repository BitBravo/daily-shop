...
function getPro(){
	...
	//showing particular category products
					...
					$cat_id = $_GET['cat'];
					$get_products = "select * from products where cat_id='$cat_id' order by rand() LIMIT 0,10";
	}
...
//displaying sub navigation categories
function getCatsSubNav(){
	global $db;
				...
				while($row_cats = mysqli_fetch_array($run_cats)){
					...
					echo "<li><a href='#$cat_title' data-toggle='tab'>$cat_title</a></li>";
				}
